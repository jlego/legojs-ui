    ...
    renderAfter(){
        ...
        if(inputEl.length){
            if(!this.spectrum){
                ...
                switch(opts.type){
                    case 1:
                        defaults.showPalette = false;
                        break;
                    case 2:
                        defaults.showPalette = false;
                        defaults.showInput = true;
                        defaults.allowEmpty = true;
                        defaults.showAlpha = true;
                        break;
                    case 3:
                        defaults.showPalette = true;
                        defaults.showPaletteOnly = true;
                        defaults.showSelectionPalette = false;
                    ...
                    case 4:
                        ...
                        defaults.allowEmpty = true;
                        defaults.showPalette = true;
                        defaults.showPaletteOnly = false;
                        defaults.showSelectionPalette = true;
                        defaults.localStorageKey = "spectrum." + opts.vid;
                        defaults.palette = palette;
                        break;
                }
                this.spectrum = inputEl.spectrum(defaults);
            }
        }
    }
    // 返回值
