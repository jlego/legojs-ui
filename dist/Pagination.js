...
var _templateObject6$1 = _taggedTemplateLiteral$1([ '<li class="lego-search-container"><search id="search_', '"></search></li>' ], [ '<li class="lego-search-container"><search id="search_', '"></search></li>' ]);
...
var Dropdown = function(_Lego$UI$Baseview) {
    ...
    _createClass$1(Dropdown, [ {
        ...
        value: function render() {
            ...
            var vDom = hx(_templateObject5$1, opts.scrollbar ? "scrollbar" : "", opts.direction ? "drop" + opts.direction : "", opts.open ? "block" : "none", opts.showSearch ? hx(_templateObject6$1, opts.vid) : "", opts.data.map(function(item) {
                return itemNav(item);
            }));
            return vDom;
        }
