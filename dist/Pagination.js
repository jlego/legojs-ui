...
var Pagination = function(_Lego$UI$Baseview) {
    ...
    _createClass(Pagination, [ {
        ...
        value: function render() {
            ...
            }) : "", showEllipsis ? hx(_templateObject5, opts.pageSize) : "", !opts.simple && showEllipsis ? hx(_templateObject6, opts.totalPages, opts.totalPages) : "", !opts.simple ? hx(_templateObject7, current >= opts.totalPages ? "disabled" : "") : "", !opts.simple && opts.showSizeChanger ? hx(_templateObject8, opts.vid, opts.pageSize, opts.vid) : "", !opts.simple && opts.showQuickJumper ? hx(_templateObject9, this.jumped ? current : "1", opts.isShowTotal ? hx(_templateObject10, typeof opts.showTotal === "function" ? opts.showTotal(totalCount) : "总数 " + totalCount) : "") : "");
            this.jumped = false;
            return vDom;
        }
    }, {
