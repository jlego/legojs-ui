...
var _templateObject3$1 = _taggedTemplateLiteral$2([ '<dropdown id="autocomplete_', '"></dropdown>' ], [ '<dropdown id="autocomplete_', '"></dropdown>' ]);
...
var Search = function(_Lego$UI$Baseview) {
    ...
    _createClass$2(Search, [ {
        ...
        value: function render() {
            ...
            var vDom = hx(_templateObject$2, opts.size ? "input-group-" + opts.size : "", opts.autoComplete ? "position: relative;" : "", opts.showSelect ? hx(_templateObject2$2, opts.vid, opts.activeValue || "请选择", opts.vid) : "", opts.vid, opts.placeholder, opts.name, val(opts.keyword), opts.autoComplete ? hx(_templateObject3$1, opts.vid) : "");
            return vDom;
        }
    }, {
        key: "_enterSearch",
