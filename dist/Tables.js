...
var _templateObject6$2 = _taggedTemplateLiteral$2([ '<li class="lego-search-container"><search id="search_', '"></search></li>' ], [ '<li class="lego-search-container"><search id="search_', '"></search></li>' ]);
...
var Dropdown = function(_Lego$UI$Baseview) {
    ...
    _createClass$2(Dropdown, [ {
        ...
        value: function render() {
            ...
            var vDom = hx(_templateObject5$2, opts.scrollbar ? "scrollbar" : "", opts.direction ? "drop" + opts.direction : "", opts.open ? "block" : "none", opts.showSearch ? hx(_templateObject6$2, opts.vid) : "", opts.data.map(function(item) {
                return itemNav(item);
            }));
            return vDom;
        }
