...
var Search = function(_Lego$UI$Baseview) {
    ...
    _createClass$1(Search, [ {
        ...
        value: function render() {
            ...
            var vDom = hx(_templateObject$1, options.size ? "input-group-" + options.size : "", options.showSelect ? hx(_templateObject2$1, options.vid, options.activeValue || "请选择", options.vid) : "", options.placeholder, options.name, val(options.keyword));
            return vDom;
        }
    }, {
        key: "_enterSearch",
