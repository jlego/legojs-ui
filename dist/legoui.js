...
var Avatar = function(_Lego$UI$Baseview) {
    _inherits$26(Avatar, _Lego$UI$Baseview);
    function Avatar() {
        var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        _classCallCheck$30(this, Avatar);
        var options = {
            events: {
                "click .add": "onAdd",
        ...
        Object.assign(options, opts);
        return _possibleConstructorReturn$26(this, (Avatar.__proto__ || Object.getPrototypeOf(Avatar)).call(this, options));
    }
    _createClass$30(Avatar, [ {
        key: "render",
        value: function render() {
            var options = this.options;
