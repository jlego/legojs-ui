...
var Rating = function(_Lego$UI$Baseview) {
    ...
    _createClass(Rating, [ {
        ...
        value: function render() {
            ...
            var vDom = hx(_templateObject, options.size ? "lego-rating-" + options.size : "", val(options.name), options.vid, options.showTip ? "rating-tooltip" : "rating", options.value, options.showLabel ? hx(_templateObject2, val(options.value)) : "");
            return vDom;
        }
    }, {
        key: "init",
