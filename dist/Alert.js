...
var Alert = function(_Lego$UI$Baseview) {
    ...
    _createClass(Alert, [ {
        ...
        value: function render() {
            ...
            var vDom = hx(_templateObject, data.type, data.description ? "lego-alert-with-description" : "", data.showIcon ? "" : "lego-alert-no-icon", data.description ? "anticon-" + iconName + "-circle-o" : "anticon-" + iconName + "-circle", data.showIcon ? "" : "-no", data.showIcon ? "" : "none", data.message, data.description ? hx(_templateObject2, data.description) : "", data.closable ? hx(_templateObject3) : "");
            return vDom;
        }
    }, {
        key: "onClose",
