(function(e) {
        ...
        p.prototype.fetch = function e(t) {
            ...
            if (this.options.dataSource) {
                ...
                r.api.forEach(function(e) {
                    r[e] = $.extend(true, {}, r.server.options[e], t);
                });
                if (r.server) {
                    var o = null;
    ...
    var p = {
        ...
        faceToText: function e(t, n, r) {
            ...
            while (arr = o.exec(t)) {
                i = i.replace(new RegExp(arr[0], "g"), n[arr[1]]);
            }
            i = this.filterTag(i);
            return i;
        },
        textToFace: function e(t, n, r) {
            ...
            if (o) {
                for (var i = 0; i < o.length; i++) {
                    var a = n.indexOf(o[i]);
                    if (a >= 0) {
                        t = t.replace(o[i], '<img face="" src="' + r + a + '.gif"/>');
                    }
                }
            }
            return t;
