(function(e) {
    ...
    p.default.registerLanguage("javascript", n(241));
    ...
    (function(t, n) {
        ...
        function Ne(e, t, n, r) {
            ...
            if (h || d > 1 && typeof g === "string" && !v.checkClone && Se.test(g)) {
                ...
                return regeneratorRuntime.wrap(function e(u) {
                    ...
                    while (1) {
                        switch (u.prev = u.next) {
                          case 0:
                            n = d, r = [], o = Array.isArray(t.api) ? t.api : [ t.api ], i = t.view;
                            u.prev = 1;
                            a = o.map(function(e) {
                                return p(regeneratorRuntime.mark(function r() {
                                    var o, a, l, s, c, f, u, d;
                                    return regeneratorRuntime.wrap(function r(p) {
                                        while (1) {
    ...
    (function(e, o) {
        (function() {
            ...
            var bt = "['’]", mt = "[" + nt + "]", vt = "[" + ht + "]", wt = "[" + at + "]", yt = "\\d+", xt = "[" + lt + "]", At = "[" + st + "]", kt = "[^" + nt + ht + yt + lt + st + pt + "]", Et = "\\ud83c[\\udffb-\\udfff]", _t = "(?:" + wt + "|" + Et + ")", Bt = "[^" + nt + "]", Ct = "(?:\\ud83c[\\udde6-\\uddff]){2}", It = "[\\ud800-\\udbff][\\udc00-\\udfff]", Rt = "[" + pt + "]", St = "\\u200d";
            var Tt = "(?:" + At + "|" + kt + ")", Lt = "(?:" + Rt + "|" + kt + ")", Ot = "(?:" + bt + "(?:d|ll|m|re|s|t|ve))?", Dt = "(?:" + bt + "(?:D|LL|M|RE|S|T|VE))?", jt = _t + "?", zt = "[" + gt + "]?", Mt = "(?:" + St + "(?:" + [ Bt, Ct, It ].join("|") + ")" + zt + jt + ")*", Nt = "\\d*(?:(?:1st|2nd|3rd|(?![123])\\dth)\\b)", Ut = "\\d*(?:(?:1ST|2ND|3RD|(?![123])\\dTH)\\b)", Ft = zt + jt + Mt, Yt = "(?:" + [ xt, Ct, It ].join("|") + ")" + Ft, Pt = "(?:" + [ Bt + wt + "?", wt, Ct, It, mt ].join("|") + ")";
            var Ht = RegExp(bt, "g");
            var Qt = RegExp(wt, "g");
            ...
            var kr = function e(t) {
                ...
                var Ls = Ai(function(e) {
                    ...
                    return zi(So(e, 1, gf, true), Ga(t, 2));
                });
                var Os = Ai(function(e) {
                    var t = ls(e);
                    t = typeof t == "function" ? t : i;
                    return zi(So(e, 1, gf, true), i, t);
                });
                function Ds(e) {
